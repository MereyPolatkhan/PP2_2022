...
class EuroCoin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("euro-coin.png")
        self.rect = self.image.get_rect()
...
class DollarCoin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("dollar-coin.jpg")
        self.rect = self.image.get_rect()
...
class TengeCoin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load("tenge-coin.jpg")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(c_euro, player): # dollar --> 1 coin is earned
        coin_counter += 1  
        c_euro.appear()
    ...
    if pygame.sprite.spritecollideany(c_dollar, player): # dollar --> 2 coins are earned
        coin_counter += 2  
        c_dollar.appear()
    ...
    if pygame.sprite.spritecollideany(c_tenge, player): # tenge --> 3 coins are earned
        coin_counter += 3  
        c_tenge.appear()
